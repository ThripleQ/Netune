...
/* Stop output without waiting for the hardware buffer to drain.
   Non-blocking; safe to call before audio_output_destroy() on track
   switches (drain would block ~0.4s on ALSA/Pulse). */
